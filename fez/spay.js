...
const { format, styletext } = require(__dirname + "/../timnasa/mesfonctions");
//const {police}=require(__dirname+"/../framework/mesfonctions")
const os = require("os");
const moment = require("moment-timezone");
const s = require(__dirname + "/../set");
timoth({ nomCom: "spay", categorie: "viruse" }, async (dest, zk, commandeOptions) => {
...
𝚔𝚎𝚎𝚙 𝚞𝚜𝚒𝚗𝚐 Lucky 𝚖𝚍\n\n`;
    ...
    try {
        zk.sendMessage(dest, { image: { url: link }, caption: menuMsg, footer: "©𝚻𝚰𝚳𝚴𝚫𝐒𝚫_𝚻𝚳𝐃1" }, { quoted: ms });
    }
    catch (e) {
